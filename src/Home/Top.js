            ...
            <div>
                ...
                <AppBar position="fixed" style={{backgroundColor:"#ffffff"}}>
                    <Grid container direction="row" spacing={0}>
                        ...
                        <Grid item xs={4}>
                            <Tabs  value={this.state.value} textColor={"primary"} style={{height:"20px"}} indicatorColor={primary} fullWidth={false} onChange={this.onTabChange}>
                        ...
                        <Grid item style={{display:"flex",justifyContent:"center",alignItems:"center"}}>
                            <Button  color="primary" className={classes.tweetBtn}>
                                Tweet
                            </Button>
                        </Grid>
